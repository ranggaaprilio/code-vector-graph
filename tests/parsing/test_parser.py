...
from code_vector_graph.parsing import parser

# Scratch dir for the fixtures these tests write. Previously they wrote into a
# committed `tmp_test_sources/` at the repo root, which coupled the suite to the
# working directory and left generated .js files in version control.
_SCRATCH = tempfile.mkdtemp(prefix="cvg-parser-tests-")
