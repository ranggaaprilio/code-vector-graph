...
from code_vector_graph.config import MODEL_CONFIGS, DEFAULT_MODEL_ID
from code_vector_graph.embeddings.embedder import HuggingFaceEmbedder, create_embedder, JINA_TASK_PREFIXES
...
class TestHuggingFaceEmbedderInit:
    @patch("code_vector_graph.embeddings.embedder.AutoTokenizer")
    @patch("code_vector_graph.embeddings.embedder.AutoModel")
...
class TestHuggingFaceEmbedderEmbedChunks:
    ...
    @patch("code_vector_graph.embeddings.embedder.torch.mps.empty_cache")
