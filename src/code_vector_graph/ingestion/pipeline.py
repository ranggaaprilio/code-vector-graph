"""Ingestion pipeline: repo -> parse -> chunk -> embed -> Qdrant + Neo4j."""
...
from code_vector_graph.parsing.glossary import (
    ...
    for batch_start in range(0, total_files, FILE_BATCH_SIZE):
        ...
        for file_info in file_batch:
            ...
            if graph_data is not None and chunk_nodes:
                ...
                # upsert. cvg-reinit-graph reconstructs the graph from
