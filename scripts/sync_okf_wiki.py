...
Reads the OKF bundle produced by scripts/build_okf_wiki.py and pushes it into the
...
Examples:
  ...
  python scripts/sync_okf_wiki.py --bundle okf-wiki --no-qdrant       # graph only
  python scripts/sync_okf_wiki.py --bundle okf-wiki --dry-run         # parse + report
"""
...
from src.okf.sync import parse_bundle, sync_neo4j, sync_qdrant  # noqa: E402
